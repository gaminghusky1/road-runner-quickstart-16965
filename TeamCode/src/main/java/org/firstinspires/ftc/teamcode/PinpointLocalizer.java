...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1540.2676548164304; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3118.630994374011; // x position of the perpendicular encoder (in tick units)
    }
